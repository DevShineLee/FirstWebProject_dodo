...
<div class="join_input" style="text-align: right;">
	Total : <font color=#b6a6d4><b><%=total_record %></b></font> 명의 회원
</div> 
<br>
    ...
    <div class="board_list">
        <div class="top">
   		...
   		<%
			...
			%>
			        <div>
			            <div class="num1"><%=k %></div>
			            <div class="id"><a href ="/admin/member/join_up.jsp?code=<%=code%>&id=<%=id %>"><%=id %></a></div>
			            <div class="nick"><%=name %></div>
			            <div class="nick"><%=nickname %></div>
			            <div class="pass"><%=pass %></div>
			            <div class="email"><%=email %></div>
			            <div class="num1"><%=level %></div>
			        </div>
				<%
				k--;
				}
