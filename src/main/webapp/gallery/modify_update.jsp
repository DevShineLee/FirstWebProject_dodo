...
if(file1_name != null && file1_name != ""){ //첨부파일 존재
	sql = "update "+code+" set table_name='"+code+"', file1='"+file1_rename+"',file1_o='"+file1_name+"',file1_s='"+thum_img+"',gongji='"+gongji+"',subject='"+subject+"',comment='"+comment+"' where uid="+uid+"";
}else{
	sql = "update "+code+" set table_name='"+code+"', gongji='"+gongji+"',subject='"+subject+"',comment='"+comment+"' where uid="+uid+"";
}
