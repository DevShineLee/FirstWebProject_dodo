...
<%
String sql = "select * from member where memberid = '" + session_id + "'";
...
<!-- 		아이디 중복확인 추가 -->
	 	...
	 	<input style="margin-left: 57px" type="text" id="memberid" name="memberid" value="<%=mem_id %>" class="input_style_3" readonly>
	</div>
	<div class="join_input">
	 	<img src="/images/heart.png" width=16>&nbsp;<b>이 름</b>
	 	<input style="margin-left: 75px" type="text" id="name2" name="name" value="<%=mem_name %>" readonly class="input_style_3">
	</div>
	<div class="join_input">
<!-- 		닉네임 중복확인 추가 -->
	 	<img src="/images/heart.png" width=16>&nbsp;<b>닉 네 임</b>
	 	<input style="margin-left: 58px" type="text" id="nickname" name="nickname" value="<%=mem_nickname %>" class="input_style_3"  readonly >
...
<!-- 자식창에서 닉네임 중복확인 결과 전송 Y or N -->
	...
	<div class="join_input">
	 	...
	 	<input style="margin-left: 27px" type="text" id="pass0" name="pass0" value="<%=mem_pass %>" class="input_style_3" readonly>
	</div>
	<div class="join_input">
...
<!-- 	<img src="/images/heart.png" width=16>&nbsp;<b>레 벨</b> -->
 		<input type="hidden" style="margin-left: 75px" id="level" name="level" value="<%=mem_level %>" class="input_style_3">
	</div>
</div>
