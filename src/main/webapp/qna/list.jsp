		...
		%>
	        <div style="background: #b6a6d4">
	            ...
	            <div class="title">
					...
					<%}%>
					<%
					String sql_c_count = "select count(*) as comment_count from comment_q where tb_uid="+uid+"";
		        ...
		        <div>
		            ...
		            <div class="title">
						...
						if(session_id != null && session_id != ""){
							if(gongji.equals("3")){//답변글이라면 %>
									<a href="view.jsp?code=<%=code%>&uid=<%=uid%>&page_now=<%=page_now%>&field=<%=field%>&search=<%=search%>">
										<img src="img/reply1.png" style="margin-bottom: -4px;" width=22>&nbsp;
										<%=subject%>
										</a>&nbsp;
							<%}else{ //질문글이라면%>
								<img src="img/questionn.png" style="margin-bottom: -4px;" width=22>&nbsp;
