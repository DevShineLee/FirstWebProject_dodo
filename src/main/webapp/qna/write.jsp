...
<div class="join_info">
	&nbsp;&nbsp;&nbsp;질문과 답변 게시판은 정보 공유를 위해 회원 전체공개로만 작성됩니다.
</div>
	...
	<div class="board_write">
		...
		<div class="write_option">
			<%if(session_level != null && session_level.equals("10")){ //관리자 작성자일때%>
				...
				<input type="radio" name="gongji" value="2" checked>&nbsp;질문&nbsp;&nbsp;&nbsp;
				<input type="radio" name="gongji" value="3">&nbsp;답변&nbsp;&nbsp;&nbsp;
			<%}else{ %>
				<input type="radio" style="margin-left: 25px;" name="gongji" value="2" checked>&nbsp;질문&nbsp;&nbsp;&nbsp;
				<input type="radio" style="margin-left: 25px;" name="gongji" value="3" >&nbsp;답변&nbsp;&nbsp;&nbsp;
			<%} %>
		</div>
	    <div class="title">
	        <dl>
