...
<div class="board_wrap">
	...
	<div class="btn_area">
	    ...
	    <button class="btn_style"><a href="/admin/member/list.jsp?code=member2">회원관리</a></button>
		<img src="/images/heart.png" width=16>
		<button class="btn_style_2"><a href="/admin/notice/list.jsp?code=notice"><b>게시판관리</b></a></button>
		<button class="btn_style"><a href="/admin/free/list.jsp?code=notice">자유게시판</a></button>
		<button class="btn_style"><a href="/admin/notice/list.jsp?code=qna">질문과답변</a></button>
		<button class="btn_style"><a href="/admin/notice/list.jsp?code=gallery">사진갤러리</a></button>
		<img src="/images/heart.png" width=16>
	</div>
