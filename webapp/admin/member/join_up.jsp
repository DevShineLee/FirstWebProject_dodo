...
<!-- 		아이디 중복확인 추가 -->
	 	...
	 	<input style="margin-left: 57px" type="text" id="memberid" name="memberid" value="<%=id %>"
	 		class="input_style_3">
	 	<input type="button" onclick="return validation()" value="중복확인" class="input_style_2">
	</div>
	<div class="join_input">
	 	<img src="/images/heart.png" width=16>&nbsp;<b>이 름</b>
	 	<input style="margin-left: 75px" type="text" id="name2" name="name" value="<%=name %>"
	 		class="input_style_3">
	</div>
	<div class="join_input">
<!-- 		닉네임 중복확인 추가 -->
	 	<img src="/images/heart.png" width=16>&nbsp;<b>닉 네 임</b>
	 	<input style="margin-left: 58px" type="text" id="nickname" name="nickname" value="<%=nickname %>"
	 		class="input_style_3" >
	 	<input type="button" onclick="return validation()" value="중복확인" class="input_style_2">
	</div>
	<div class="join_input">
	 	<img src="/images/heart.png" width=16>&nbsp;<b>현재비밀번호</b>
	 	<input style="margin-left: 27px" type="text" id="pass0" name="pass0" value="<%=pass %>" readonly class="input_style_3">
	</div>
	<div class="join_input">
	 	<img src="/images/heart.png" width=16>&nbsp;<b>새비밀번호</b>
	 	<input style="margin-left: 40px" type="text" id="pass1" name="pass1" value=""
	 		class="input_style_3" placeholder="변경시킬 비밀번호를 입력하세요.">
	</div>
	<div class="join_input">
	 	<img src="/images/heart.png" width=16>&nbsp;<b>비밀번호확인</b>
	 	<input style="margin-left: 27px" type="text" id="pass2" name="pass2" value="" 
	...
	<div class="join_input">
	 	...
	 	<input style="margin-left: 75px" id="level" name="level" value="<%=level %>" class="input_style_3">
	</div>
</div>
