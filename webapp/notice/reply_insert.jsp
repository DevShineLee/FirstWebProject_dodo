...
String sql = "insert into "+code+" (id,name,nickname,gongji,subject,comment,signdate, file1, file1_o, file1_s,fid,thread) values ('"+session_id+"','"+session_name+"','"+session_nickname+"','"+gongji+"','"+subject+"','"+comment+"','"+today+"','"+file1_rename+"','"+file1_name+"','"+thum_img+"',"+fid+",'"+new_thread+"')";
//out.print(sql);
